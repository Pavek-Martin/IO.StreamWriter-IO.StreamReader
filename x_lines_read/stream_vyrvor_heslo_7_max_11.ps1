...
$policek_na_radku=3843

for ( $aa = 0; $aa -le 125; $aa++ ) { # 126 znaku hesla ( plati pro vsechny verze )
$poc_znaky = 1 # vzdy znovu definovat a nastavit na hodnotu 1 !!!
#$rnd = Get-Random -Minimum 1 -Maximum 3843 # int 1-3844 ( 3844 znaku na jednom radku verze klice 1.3 max )
$rnd = Get-Random -Minimum 1 -Maximum $policek_na_radku # novy verze 1.3 musi bejt 1-3843 !!!!
$rnd = 0 # 1 = 01
#$rnd = 3842  # 3843 = ZZ
#echo $rnd"<"
...
$do_konce_radku = $policek_na_radku-$poc_znaky # 3844 znaku na jednom zadku v matici verze 1.3 max
#echo $do_konce_radku
