...
$path_input_file+= "Sifrovaci_program_GUI_PowerShell_verze_1.3_max\keys\max_1"
...
$rnd = Get-Random -Minimum 1 -Maximum 3843 # novy verze 1.3 musi bejt 1-3843 !!!!
